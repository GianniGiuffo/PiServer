...
internal static class TmdbGenreMap
{
    ...
    private static Dictionary<string, int> BuildReverseMovieGenres()
    {
        ...
        // Italian Jellyfin metadata aliases.
        dict.TryAdd("Azione", 28);
        dict.TryAdd("Avventura", 12);
        dict.TryAdd("Animazione", 16);
        dict.TryAdd("Commedia", 35);
        dict.TryAdd("Documentario", 99);
        dict.TryAdd("Dramma", 18);
        dict.TryAdd("Famiglia", 10751);
        dict.TryAdd("Storia", 36);
        dict.TryAdd("Musica", 10402);
        dict.TryAdd("Mistero", 9648);
        dict.TryAdd("Romantico", 10749);
        dict.TryAdd("Fantascienza", 878);
        dict.TryAdd("Film TV", 10770);
        dict.TryAdd("Guerra", 10752);
        return dict;
    }
    ...
    private static Dictionary<string, int> BuildReverseTvGenres()
    {
        ...
        // Italian Jellyfin metadata aliases.
        dict.TryAdd("Azione", 10759);
        dict.TryAdd("Avventura", 10759);
        dict.TryAdd("Azione e avventura", 10759);
        dict.TryAdd("Animazione", 16);
        dict.TryAdd("Commedia", 35);
        dict.TryAdd("Documentario", 99);
        dict.TryAdd("Dramma", 18);
        dict.TryAdd("Famiglia", 10751);
        dict.TryAdd("Bambini", 10762);
        dict.TryAdd("Mistero", 9648);
        dict.TryAdd("Notizie", 10763);
        dict.TryAdd("Fantascienza", 10765);
        dict.TryAdd("Fantascienza e fantasy", 10765);
        dict.TryAdd("Guerra e politica", 10768);
        return dict;
    }
